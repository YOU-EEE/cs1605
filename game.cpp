 ...
 */
    ...
    int y = mInformationHeight + rand()%mGameBoardHeight;
    while(x <= 1 || x >= mGameBoardWidth-1 || y <= 0 || y >= mGameBoardHeight-1 || mPtrSnake->isPartOfSnake(x,y)){
